...
def RemoveFileAndCreateNewZip(zipfname, filenamesToRemove, _dir):
    try:
        tempname = os.path.join(_dir, 'new.zip')
...
if __name__ == "__main__":
    ...
    for csvFileName in CSV_Files:
        ...
        with open(filename) as f:
            ...
            RemoveFileAndCreateNewZip(fileDir + TemplateName, ['content.xml'], fileDir+"/ConvertedFiles")
